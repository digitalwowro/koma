...
<div class="form-group">
    ...
    <div class="col-lg-10">
        <table class="table table-striped table-hover table-bordered table-field-options">
            ...
            <tbody>
                @if (isset($category))
                    @foreach ($category->fields as $i => $field)
...
<div class="form-group">
    <div class="col-lg-10 col-lg-offset-2">
        <button type="submit" class="btn btn-primary">{{ isset($category) ? 'Save' : 'Add' }}</button>
...
@section('footer')
    <script>
        $(document).ready(function() {
            ...
            $('#jstree').jstree({
                core: {
                    data: {!! json_encode($category->categories ?? []) !!},
                    force_text : true,
                    check_callback: true,
                    animation: 0,
                },
            ...
            function refreshTr($tr) {
                ...
                $.post('{{ route('category.get-options') }}', params, function(r) {
