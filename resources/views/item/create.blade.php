...
@section('content')
    <section class="content-header">
        <h1>Devices<small>Add New {{ Str::singular($category->title) }} Device</small></h1>
    ...
    <section class="content">
        {!! Form::open(['route' => ['item.store', $category->id], 'method' => 'POST', 'class' => 'form-horizontal', 'role' => 'form']) !!}
